...
public partial class MenuViewModel : ObservableObject //ViewModelCore
{
    private Window _window;
    private WindowResizer _windowResizer;


    #region #INotifyPropertyChanged 버전
    ...
    //public ApplicationPage _currentPage;
